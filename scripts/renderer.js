class Renderer {
    ...
    drawSlide0(framebuffer) {
        ...
        if (this.show_points) {
            ...
            this.drawVertex(p02, [0, 0, 0, 255], framebuffer);
            this.drawVertex(p12, [0, 0, 0, 255], framebuffer);
            this.drawVertex(p22, [0, 0, 0, 255], framebuffer);
            this.drawVertex(p32, [0, 0, 0, 255], framebuffer);
        }
    }
